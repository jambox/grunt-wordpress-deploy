(function() {
  ...
  exports.init = function(grunt) {
    ...
    exports.db_adapt = function(local_env, target_env, src_file, dest_file) {
    ...
    exports.replace_strings_from_sql = function(target_env, dest_file, output) {
      var file_to_run_replace_on, i, j, k, len, len1, pair, ref, ref1, replaceString, replaced_sql, searchString;
      // Write tmp file to run replacement on (solution b/c I could NOT overrite any SQL files...weird...)
      file_to_run_replace_on = dest_file + '.tmp';
      grunt.file.write(file_to_run_replace_on, sqldump);
